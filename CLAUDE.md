...
`CLAUDE.md` itself is gitignored (commit `997cfe2`). Treat it as local session context, not a team artifact — never `git add` it. Team-facing docs live in `docs/*.md`.
